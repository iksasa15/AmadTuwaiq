...
| **API** | FastAPI | `/companies`, `/flags`, `/simulate`, `/portfolio/scan`, `POST /refresh` |
...
| الميزة | الوصف | API |
|--------|--------|-----|
| **محاكاة ماذا لو؟** | تعديل افتراضي للإيرادات والذمم وإعادة حساب الدرجة فورًا | `POST /api/v1/simulate` |
| **آلة الزمن** | تطور الدرجة مع تمييز الأزمات المعلنة رسميًا (موبايلي 2014) | `GET /api/v1/companies/{ticker}/timeline` |
| **درع الإنماء** | رفع CSV/XLSX بمحفظة ائتمانية وفحص جماعي | `POST /api/v1/portfolio/scan` |
| **أسئلة الاستجواب** | سؤال مقترح لكل إشارة حمراء مع أرقام من الأدلة | حقل `interrogation_prompt_ar` في `/flags` |

ملف ديمو للمحفظة: [`data/demo/alinma_corporate_portfolio_2025.xlsx`](data/demo/alinma_corporate_portfolio_2025.xlsx)
